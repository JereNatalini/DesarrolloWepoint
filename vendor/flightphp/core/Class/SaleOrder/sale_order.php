...
class SalesOrder {
    ...
    // Al usar este constructor se setean los valores default y quedan por setear customer_id, reference_number, line_items
    public function __construct() {
        ...
        $this->payment_terms_label = "Pagadero a la recepcion";
